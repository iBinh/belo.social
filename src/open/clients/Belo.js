...
export class Belo {
    ...
    get icon() { return "images/client-icons/belo.svg"; }
    get appleAssociatedAppId() { return "EKF7MCB3S2.chat.belo.app-ios"; }
    get name() {return "Belo"; }
    get description() { return 'Belo - Secure messaging'; }
    get homepage() { return "https://belochat.com"; }
    get author() { return "Belo"; }
    ...
    getDeepLink(platform, link) {
        ...
        if (isWebPlatform /*|| platform === Platform.iOS */) {
            ...
            return `belo://vector/webapp/#/${fragmentPath}`;
        } else {
            return `belo://${fragmentPath}`;
        }
    }
    ...
    getInstallLinks(platform) {
        switch (platform) {
            case Platform.iOS: return [new AppleStoreLink('Belo', 'id1639520032')];
            case Platform.Android: return [new PlayStoreLink('com.belo.chat'), new FDroidLink('com.belo.chat')];
            default: return [new WebsiteLink("https://belochat.com")];
        }
    }
