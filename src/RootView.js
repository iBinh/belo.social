    ...
    render(t, vm) {
        return t.div({className: "RootView"}, [
            ...
            t.div({className: "footer"}, [
                // t.p(t.img({src: "images/client-icons/belo.svg"})),
                ...
                //     t.li(externalLink(t, "https://github.com/matrix-org/belo.social", "GitHub project")),
                //     t.li(externalLink(t, "https://github.com/matrix-org/belo.social/tree/main/src/open/clients", "Add your app")),
